// Layar Buka Kunci (PIN + biometrik) — komponen dapat dipakai ulang. Dirender
// sebagai OVERLAY oleh LockGate (gerbang kunci global) dan oleh route /unlock.
// PIN diverifikasi ke server (/pin/verify); biometrik → segarkan sesi.
...
/**
 * @param onUnlocked dipanggil setelah membuka kunci berhasil (mis. navigasi).
 *   Overlay global tak perlu navigasi (cukup tutup overlay) → biarkan undefined.
 */
export function LockScreen({ onUnlocked }: { onUnlocked?: () => void }) {
  ...
  const backToLogin = useCallback(async () => {
    await signOut();
    markUnlocked(); // tutup overlay; layar login tak perlu dikunci
