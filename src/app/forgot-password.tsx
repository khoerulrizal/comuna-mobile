// Lupa Password — kirim tautan reset ke email (alur link-via-email).
// Tahap: form email → sukses "cek email Anda". Lintas iOS/Android.
      ...
      {sent ? (
        ...
        >
          ...
          >
            ...
            >
              <Icon name="shield" size={28} color={colors.brand[600]} strokeWidth={2} />
            </View>
            ...
            <Button
              label={loading ? "Mengirim…" : "Kirim Tautan Reset"}
              size="lg"
              full
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", gap: 22 }}>
        ...
        <View style={{ alignItems: "center", gap: 10, paddingHorizontal: 12 }}>
          ...
          >
            ...
            terdaftar, kami telah mengirim tautan untuk mengatur ulang password. Cek kotak masuk
            (dan folder spam) Anda.
          </Txt>
        </View>
      </View>
      <View style={{ gap: 12 }}>
        <Button label="Kembali ke Masuk" size="lg" full onPress={() => router.replace("/login")} />
