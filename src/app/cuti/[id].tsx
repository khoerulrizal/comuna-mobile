...
import {
  cancelLeaveRequest, formatLeaveDate, getLeaveRequest, leaveRangeLabel,
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.neutral[25], paddingTop: insets.top }}>
      ...
      {loading ? (
        ...
        <>
          <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: data.status === "PENDING" ? insets.bottom + 90 : insets.bottom + 24 }}>
            {/* Status hero */}
